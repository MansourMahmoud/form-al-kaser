...
const Footer = () => {
  ...
  return (
    <div className="px-2 dark-bg-900 dark-text flex flex-col gap-2 items-center justify-center flex-wrap text-center min-h-[25vh] bg-gray-800 shadow-2xl shadow-gary-900">
