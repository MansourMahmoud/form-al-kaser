...
const IconDarkMode = ({ openMenu, setOpenMenu, setIsDarkModeActive }) => {
  ...
  return (
    <Menu open={openMenu} handler={setOpenMenu} allowHover>
      ...
      <MenuList className="w-fit grid grid-cols-1 gap-3 overflow-visible dark:bg-darkMode-dark300 dark:text-darkMode-dark700 bg-darkMode-dark800 text-darkMode-dark50 outline-none border-none z-50">
